...
```
The table shows that R-value, Rank difference, and Female infant present were the only categories that were significant. 
I believe that the authors took their data from R and then made a pretty table on excel.  So, that is what I did. 
As a point of reference, here is what it should look like, based upon the published table.
